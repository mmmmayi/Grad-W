...
PROJECT_DIR = "exp/transCov_sclean_0.001_overall_detachC_noLM_encoder_weight/wav_14"
MODEL_PATH = "exp/transCov_sclean_0.001_overall_detachC_noLM_encoder_weight/models/model_14.pt"
mode = 'quality'
